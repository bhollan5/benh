...
export default {
  ...
  methods: {
      ...
      parseList: function(field, pos){
        var question = this.$parent.questions[pos];
        ...
        // if(question.detail.length == 0){
          // this.$parent.questions[pos].word = field[counter-1];
        // }
//        console.log("||" + this.$parent.questions[pos].word + "||");
        question.detail.push(temp);
        // TEST OUTPUT
        //var test = this.$parent.questions[pos].detail;
        //console.log(this.$parent.questions[pos].detail.length);
      },
      ...
      parseConcept: function(field, noteType, splitter) {
        ...
        this.$parent.questions.push(question);
